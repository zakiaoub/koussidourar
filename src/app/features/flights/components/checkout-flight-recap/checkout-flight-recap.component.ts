...
@Component({
  ...
  imports: [CommonModule, TranslationModule, PromoCodeComponent, CheckoutSummaryComponent, CityImageComponent, FilterPipe, Tooltip, StopoverPipe, BookingClassPipe, IconComponent],
  templateUrl: './checkout-flight-recap.component.html',
  styleUrl: './checkout-flight-recap.component.css'
})
